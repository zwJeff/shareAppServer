...
public class AnswerCardModel  implements java.io.Serializable {
	...
	/** minimal constructor */
    public AnswerCardModel(Integer taskId, Integer taskStatu, Integer answerUserId) {
        this.taskId = taskId;
    ...
    /** full constructor */
    public AnswerCardModel(Integer taskId, Integer taskStatu, Date finishTime, Integer answerUserId, String question0Answer, Integer question0Score, String question1Answer, Integer question1Score, String question2Answer, Integer question2Score, String question3Answer, Integer question3Score, String question4Answer, Integer question4Score, String question5Answer, Integer question5Score, String question6Answer, Integer question6Score, String question7Answer, Integer question7Score, String question8Answer, Integer question8Score, String question9Answer, Integer question9Score, Integer totalScore) {
        this.taskId = taskId;
        this.taskStatu = taskStatu;
	...
	public AnswerCardModel(Integer taskId, Date finishTime,
			Integer answerUserId, String question0Answer,
			Integer question0Score, String question1Answer,
			Integer question1Score, String question2Answer,
			Integer question2Score, String question3Answer,
			Integer question3Score, String question4Answer,
			Integer question4Score, String question5Answer,
			Integer question5Score, String question6Answer,
			Integer question6Score, String question7Answer,
			Integer question7Score, String question8Answer,
			Integer question8Score, Integer totalScore, String question9Answer,
			Integer question9Score) {
